...
output "target_role_name"           { value = azurerm_role_definition.app_operator.name }
output "target_role_definition_id"  { value = azurerm_role_definition.app_operator.role_definition_id }
output "target_role_resource_id"    { value = azurerm_role_definition.app_operator.role_definition_resource_id }
